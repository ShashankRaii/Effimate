  ...
  <div class="main">
    ...
    <div class="chart chartByHours">
      <div class="mt-10 mb-20">
        <input
          type="button"
          :class="['chart-btn', chart == TypeOfChart.Hourly ? 'active' : '']"
          :value="t('byHours.message')"
          @click="openChart(TypeOfChart.Hourly)"
        />
        <input
          type="button"
      ...
      <HourlyChart v-if="chart == TypeOfChart.Hourly" />
...
onMounted(() => {
  chart.value = TypeOfChart.Hourly;
});
